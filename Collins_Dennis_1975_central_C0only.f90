...
!------------------- Case configuration ---------------------------------
    ...
    XI_CASES(:,1)  = (/0.1_dp, 0.1_dp, 0.1_dp, 0.1_dp/)
    XI_CASES(:,2)  = (/0.1_dp, 0.1_dp, 0.1_dp, 0.1_dp/)
    XI_CASES(:,3)  = (/0.1_dp, 0.1_dp, 0.1_dp, 0.1_dp/)
    XI_CASES(:,4)  = (/0.1_dp, 0.1_dp, 0.1_dp, 0.1_dp/)
    XI_CASES(:,5)  = (/0.1_dp, 0.1_dp, 0.1_dp, 0.1_dp/)
    XI_CASES(:,6)  = (/0.1_dp, 0.1_dp, 0.1_dp, 0.1_dp/)
    XI_CASES(:,7)  = (/0.5_dp, 0.1_dp, 0.1_dp, 0.5_dp/)
    XI_CASES(:,8)  = (/0.5_dp, 0.1_dp, 0.1_dp, 0.5_dp/)
    XI_CASES(:,9)  = (/0.5_dp, 0.1_dp, 0.1_dp, 0.5_dp/)
    XI_CASES(:,10) = (/0.3_dp, 0.1_dp, 0.1_dp, 0.7_dp/)
...
!------------------- D-stepping setup -----------------------------------
      ...
      STEPPING = .FALSE.
      IF (D_TARGET > 1000._dp .AND. DSTART > 0._dp .AND. D_TARGET > DSTART) THEN
        D_CURRENT = DSTART
        STEPPING = .TRUE.
